...
export const staffEn = {
  ...
  admin: {
    ...
    families: {
      ...
      accesses: {
        toggle: "Sign-ins by {child} ({count})",
        caption: "Latest recorded sign-ins by {child}",
        when: "When",
        kind: "Kind",
        from: "From where",
        device: "Device",
        signals: "Signals",
        unknownPlace: "No location",
        unknownDevice: "No device",
        noSignals: "None",
        none: "Has not signed in yet.",
        kindRedeemed: "Link redeemed",
        kindLoginOk: "Successful sign-in",
        kindLoginFailed: "Failed attempt",
        kindDeviceForgotten: "Device forgotten",
        signalNewDevice: "New device",
        signalCountryJump: "Country jump",
        signalOutOfNetwork: "Redeemed off-network",
        signalSharedIp: "IP with several accounts",
        privacyNote:
          "Neither the IP address nor the coordinates are shown. They are the centre of the city, not anyone's home, and would suggest a precision the data does not have.",
      },
