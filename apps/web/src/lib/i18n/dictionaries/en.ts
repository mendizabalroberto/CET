...
export const en = {
  ...
  tutor: {
    ...
    child: {
      ...
      plan: {
        ...
        success: {
          ...
          planGenerado: "Plan created by the assistant. {name} will see it in “Today”.",
          planEditado: "Changes saved.",
          planCancelado: "Plan cancelled. {name} won't have tasks from this plan any more.",
          boletinDescartado: "Report card discarded.",
          examenAnadido: "Exam written down. Generate another plan so it takes it into account.",
          examenBorrado: "Exam removed.",
          examenesLeidos: "We read the calendar: {count} new exams out of {total}. Generate another plan so it takes them into account.",
        },
        ...
        deleteBody: "{name} will stop seeing the tasks from this plan. What's been done so far is kept.",
        deleteButton: "Delete the plan",
        ...
        intro: "Upload the report card PDF and the assistant reads the grades and builds the plan on its own.",
        uploadTitle: "The report card",
        uploadAnotherTitle: "Upload another report card",
        uploadLabel: "Report card (PDF from the school)",
        uploadButton: "Generate the plan with AI",
        uploading: "Reading…",
        uploadHelp: "Only the original PDF works. A scanned photo can't be read yet.",
        analyzingTitle: "Analysing the report card…",
        analyzingSteps: [
          "Read the PDF",
          "Interpret the grades (AI)",
          "Propose the split (AI)",
          "Create the tasks",
        ],
        analyzingHelp: "Usually takes between half a minute and two.",
        analyzingBubbles: [
          "Beep. Sheet received. Reading…",
          "It says “Math” here… noted.",
          "This grade is good. Moving on.",
          "Working out how much time each subject gets…",
          "Almost there. Don't mess up my antenna.",
        ],
        analyzingRobotLabel: "Robot reading the report card. Tap it to make it talk.",
        analyzingHint: "Tap the robot.",
        lastReportTitle: "The latest report card",
        lastReportLine: "{term} · {count} subjects · uploaded on {date}",
        commentLabel: "Anything you want to tell the assistant?",
        commentPlaceholder: "More maths! English is going well…",
        commentHelp: "It takes this into account when splitting the time. You can leave it empty.",
        newPlanButton: "Generate a new plan",
        uploadNewButton: "Upload a new report card",
        uploadNewHelp: "When the next report card arrives from school, upload it here and the plan will be built from its grades.",
        choosePdf: "Choose the PDF",
        ...
        term: "Term {n}, {year}",
        termUnknown: "{year}",
        gradesSave: "Save grades and regenerate the plan",
        ...
        weightsSum: "The percentages must add up to 100.",
        recommendationsTitle: "Assistant's suggestions",
        weekTitle: "This week's calendar",
        weekPrevious: "← Previous week",
        weekNext: "Next week →",
        weekOf: "{from} to {to}",
        weekFree: "Free",
        weekOutside: "Outside the plan",
        weekLesson: "Lesson",
        weekPractice: "Practice",
        weekStudied: "Studied {studied} of {planned} min",
        weekDone: "Done",
        activeMinutesShort: "{count} min",
        examsTitle: "{name}'s exams",
        examsIntro: "Write down exam dates and the plan will focus on that subject in the days before. You can also upload the school's calendar.",
        examsEmpty: "No exams written down yet.",
        examsGeneral: "General (all subjects)",
        examsFromDocument: "from the school calendar",
        examsDelete: "Remove",
        examsDate: "Date",
        examsSubject: "Subject",
        examsNote: "Note (optional)",
        examsNotePlaceholder: "Fractions, unit 3…",
        examsAdd: "Add exam",
        examsAdding: "Adding…",
        examsUploadButton: "Upload the exam calendar (PDF)",
        examsUploadHelp: "The assistant reads the dates and subjects and adds them here. You can remove any that don't belong.",
        examsUploadSubmit: "Read the calendar",
        examsAnalyzing: "Reading the exam calendar…",
        examsAnalyzingSteps: ["Read the PDF", "Find dates and subjects (AI)", "Save the exams"],
        subjects: {
          english: "English",
          ict: "ICT",
          math: "Maths",
        ...
        prioritiesTitle: "What to read and practise first",
        prioritiesNote: "Chosen by the assistant from the grades, what they've already studied and the material available.",
        prioritiesRead: "Read:",
        prioritiesPractice: "Practise:",
        ...
        editButton: "Edit the plan",
        editSave: "Save changes",
        editCancel: "Leave it as it is",
        regenerateButton: "Generate another plan",
        ...
        noPlanBody: "Press “Generate another plan” or fix the grades and regenerate.",
    ...
    errors: {
      ...
      examenInvalido: "Check the exam's date and subject.",
      examenPasado: "That date has already passed.",
      examenRepetido: "That exam is already written down.",
      examenesNoLeidos: "We couldn't find any exams in that PDF. Check that it's the school's exam calendar.",
      examenesTodosPasados: "All the exams in that calendar have already passed.",
