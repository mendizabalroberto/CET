...
export const es: Dictionary = {
  ...
  tutor: {
    ...
    child: {
      ...
      plan: {
        ...
        success: {
          ...
          planGenerado: "Plan creado por el asistente. {name} lo verá en «Hoy».",
          planEditado: "Cambios guardados.",
          planCancelado: "Plan cancelado. {name} ya no tendrá tareas de este plan.",
          boletinDescartado: "Boletín descartado.",
          examenAnadido: "Examen apuntado. Genera otro plan para que lo tenga en cuenta.",
          examenBorrado: "Examen quitado.",
          examenesLeidos: "Hemos leído el calendario: {count} exámenes nuevos de {total}. Genera otro plan para que los tenga en cuenta.",
        },
        ...
        deleteTitle: "Borrar este plan",
        deleteBody: "{name} dejará de ver las tareas de este plan. Lo hecho hasta hoy se conserva.",
        deleteButton: "Borrar el plan",
        deleteConfirm: "Sí, borrar",
        deleteKeep: "No, dejarlo",
        deleting: "Borrando…",
        ...
        intro: "Sube el PDF del boletín y el asistente lee las notas y crea el plan solo.",
        uploadTitle: "El boletín",
        uploadAnotherTitle: "Subir otro boletín",
        uploadLabel: "Boletín (PDF del colegio)",
        uploadButton: "Generar el plan con IA",
        uploading: "Leyendo…",
        uploadHelp: "Solo sirve el PDF original. Una foto escaneada todavía no se puede leer.",
        analyzingTitle: "Analizando el boletín…",
        analyzingSteps: [
          "Leer el PDF",
          "Interpretar las notas (IA)",
          "Proponer el reparto (IA)",
          "Crear las tareas",
        ],
        analyzingHelp: "Suele tardar entre medio minuto y dos.",
        analyzingBubbles: [
          "Bip. Hoja recibida. Leyendo…",
          "Aquí pone «Math»… anotado.",
          "Esta nota es buena. Sigo.",
          "Calculando cuánto tiempo a cada materia…",
          "Casi está. No me despeines.",
        ],
        analyzingRobotLabel: "Robot leyendo el boletín. Tócalo para que diga algo.",
        analyzingHint: "Toca al robot.",
        lastReportTitle: "El último boletín",
        lastReportLine: "{term} · {count} materias · subido el {date}",
        commentLabel: "¿Algo que quieras decirle al asistente?",
        commentPlaceholder: "¡Más matemáticas! El inglés va bien…",
        commentHelp: "Lo tiene en cuenta al repartir el tiempo. Puedes dejarlo vacío.",
        newPlanButton: "Generar nuevo plan",
        uploadNewButton: "Subir un boletín nuevo",
        uploadNewHelp: "Cuando llegue el siguiente boletín del colegio, súbelo aquí y el plan se hará con sus notas.",
        choosePdf: "Elegir el PDF",
        noFileChosen: "Ningún archivo elegido todavía.",
        ...
        termUnknown: "{year}",
        gradesSave: "Guardar notas y regenerar el plan",
        ...
        weightsSum: "Los porcentajes tienen que sumar 100.",
        recommendationsTitle: "Sugerencias del asistente",
        weekTitle: "Calendario de la semana",
        weekPrevious: "← Semana anterior",
        weekNext: "Semana siguiente →",
        weekOf: "Del {from} al {to}",
        weekFree: "Libre",
        weekOutside: "Fuera del plan",
        weekLesson: "Lección",
        weekPractice: "Práctica",
        weekStudied: "Estudió {studied} de {planned} min",
        weekDone: "Hecha",
        activeMinutesShort: "{count} min",
        examsTitle: "Exámenes de {name}",
        examsIntro: "Apunta las fechas de examen y el plan concentrará esa materia los días de antes. También puedes subir el calendario del colegio.",
        examsEmpty: "Todavía no hay exámenes apuntados.",
        examsGeneral: "General (todas las materias)",
        examsFromDocument: "del calendario del colegio",
        examsDelete: "Quitar",
        examsDate: "Fecha",
        examsSubject: "Materia",
        examsNote: "Nota (opcional)",
        examsNotePlaceholder: "Fracciones, tema 3…",
        examsAdd: "Añadir examen",
        examsAdding: "Añadiendo…",
        examsUploadButton: "Subir el calendario de exámenes (PDF)",
        examsUploadHelp: "El asistente lee las fechas y las materias y las añade aquí. Luego puedes quitar las que sobren.",
        examsUploadSubmit: "Leer el calendario",
        examsAnalyzing: "Leyendo el calendario de exámenes…",
        examsAnalyzingSteps: ["Leer el PDF", "Encontrar fechas y materias (IA)", "Guardar los exámenes"],
        subjects: {
          english: "Inglés",
          ict: "Informática",
          math: "Matemáticas",
        ...
        prioritiesTitle: "Qué leer y qué practicar primero",
        prioritiesNote: "Lo eligió el asistente mirando las notas, lo que ya estudió y el material que hay.",
        prioritiesRead: "Leer:",
        prioritiesPractice: "Practicar:",
        ...
        editButton: "Editar el plan",
        editSave: "Guardar cambios",
        editCancel: "Dejarlo como está",
        regenerateButton: "Generar otro plan",
        ...
        noPlanBody: "Pulsa «Generar otro plan» o corrige las notas y regenera.",
    ...
    errors: {
      ...
      examenInvalido: "Revisa la fecha y la materia del examen.",
      examenPasado: "Esa fecha ya pasó.",
      examenRepetido: "Ese examen ya está apuntado.",
      examenesNoLeidos: "No hemos encontrado exámenes en ese PDF. Comprueba que es el calendario de exámenes del colegio.",
      examenesTodosPasados: "Todos los exámenes de ese calendario ya pasaron.",
