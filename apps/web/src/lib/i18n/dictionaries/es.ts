  ...
  tutor: {
    ...
    child: {
      ...
      plan: {
        ...
        uploadLabel: "Bolet\u00edn (PDF del colegio)",
        uploadButton: "Leer el bolet\u00edn",
        uploading: "Leyendo\u2026",
        uploadHelp: "Solo sirve el PDF original. Una foto escaneada todav\u00eda no se puede leer.",
        extractedTitle: "Lo que hemos le\u00eddo",
        extractedHelp: "Revisa cada nota. Corrige la que est\u00e9 mal antes de confirmar.",
        colSubject: "Materia",
        colGrade: "Nota",
        colBand: "Banda",
        notPlanned: "No se planifica: la app no cubre esta materia",
        term: "Trimestre {n}, {year}",
        termUnknown: "{year}",
        confirmButton: "Confirmar las notas",
        confirming: "Confirmando\u2026",
        confirmed: "Confirmado el {date}",
        bands: {
          ...
          failing: "Insuficiente",
        },
        proposeButton: "Proponer un plan",
        proposing: "Pens\u00e1ndolo\u2026",
        proposalTitle: "La propuesta del asistente",
        minutesLabel: "Minutos al d\u00eda",
        minutesHelp: "El asistente sugiere; t\u00fa decides. Es el compromiso de la familia.",
        weightsTitle: "Reparto del tiempo por materia",
        recommendationsTitle: "Sugerencias del asistente",
        recommendationsNote: "Son sugerencias para ti, no mediciones.",
        ceilingsTitle: "D\u00f3nde se acaba el contenido",
        ceilingLine:
          "{subject}: solo hay material para unos {available} min en toda la ventana (se ped\u00edan {requested}). El resto se reparti\u00f3 a las dem\u00e1s materias.",
        windowLine: "Del {from} al {to}, hasta: {milestone}",
        createButton: "Crear el plan",
        creating: "Creando\u2026",
        replaceWarning: "Esto sustituye al plan actual.",
        activeTitle: "Plan actual",
        activeRange: "Del {from} al {to}",
        activeMinutes: "{count} min al d\u00eda",
        activeTasks: "{count} tareas",
        reportsTitle: "Partes nocturnos",
        reportLine: "{date}: previsto {planned} min, estudiado {studied} min, {items} \u00edtems, {correct} aciertos",
        reportsEmpty: "El primer parte llega esta noche.",
        noPlanTitle: "Todav\u00eda no hay plan",
        noPlanBody: "Confirma las notas y prop\u00f3n un plan para tener uno.",
        noReportCard: "Empieza subiendo el bolet\u00edn.",
      },
      content: {
        ...
        studyTitle: "Cómo ha estudiado esta",
        studyMinutes: "Tiempo en esta lección",
        studyVisits: "Veces que se ha sentado con ella",
        studyOpens: "Veces que la ha abierto",
        studyNone: "Todavía no ha abierto esta.",
        studyUnknown: "Ahora mismo no podemos enseñarte el tiempo de esta.",
        studyWindow: "Últimos {days} días.",
        studyDone: "La ha dado por terminada.",
        studyStarted: "La ha empezado.",
      ...
      practice: {
        title: "Lo que ha practicado {name}",
        subtitle:
          "Cada pregunta que contestó: las que acertó, las que no, y dónde pidió una pista.",
        window: "Últimos {days} días.",
        emptyTitle: "Todavía no ha practicado",
        emptyBody:
          "Cuando tu hijo practique, verás aquí qué temas trabajó y cómo le fue cada pregunta.",
        errorTitle: "No hemos podido cargar su práctica",
        errorBody: "Inténtalo dentro de un momento.",
        truncated:
          "Hay más de lo que cabe de una vez. Esto es la parte más reciente del periodo.",
        hintNote:
          "Pedir una pista no es una falta. Es lo que se hace cuando uno se atasca, y merece la pena ver dónde pasa.",
        byTopicTitle: "Por tema",
        topic: "Tema",
        ...
        solutions: "Veces que miró la respuesta",
        unknownTopic: "Otro tema",
        oneByOneTitle: "Una a una",
        oneByOneBody: "Lo más reciente primero.",
        when: "Cuándo",
        outcome: "Cómo fue",
        outcomeRight: "Acertó",
        outcomeWrong: "Falló",
        theirAnswer: "Respondió",
        noAnswer: "Lo dejó en blanco",
        seconds: "{count} s",
        secondsLabel: "Tiempo",
        hintsOnItem: "{count} pista(s)",
        changesOnItem: "cambió de idea {count} vez/veces",
        noHelp: "Sin ayuda",
      },
      progress: {
    ...
    errors: {
      ...
      planPdfInvalido: "Ese archivo no es un PDF, o pesa m\u00e1s de 10 MB.",
      planPdfSinTexto: "Este PDF es una imagen escaneada y no puedo leerlo. Sube el PDF original del colegio.",
      planBoletinRepetido: "Ese bolet\u00edn ya est\u00e1 aqu\u00ed.",
      planExtraccionInvalida: "No hemos podido leer las notas de ese PDF. Comprueba que es el bolet\u00edn del colegio.",
      planModeloCaido: "El asistente no responde ahora mismo. No se ha perdido nada; prueba en un momento.",
