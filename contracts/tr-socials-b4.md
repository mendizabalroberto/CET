...
context: [contracts/fuentes/socials-b4.json, supabase/migrations/0028_leccion_en_espanol.sql]
verify: node scripts/deepseek/validar-traduccion.mjs contracts/fuentes/socials-b4.json supabase/migrations/0041_socials_es.sql
setup: ninguno
rounds: 5
...
Te toca **la leccion 4**: 10 bloques, 4192 caracteres.
...
`contracts/fuentes/socials-b4.json`, que te doy entero mas abajo. Cada bloque
...
```
node scripts/deepseek/validar-traduccion.mjs contracts/fuentes/socials-b4.json supabase/migrations/0041_socials_es.sql
```

Ese verificador **lo escribio el supervisor, no tu**, y comprueba por codigo de
salida: cobertura de los 10 bloques uno a uno, que el marcado HTML se
...
- Traducir a medias y dejar bloques fuera. El verificador cuenta los 10.
