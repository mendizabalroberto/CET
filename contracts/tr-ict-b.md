...
id: tr-ict-b
model: chat
territory: [supabase/migrations/0032_*]
forbidden: [packages/ui/src/index.ts, supabase/migrations/0028_leccion_en_espanol.sql]
context: [contracts/fuentes/ict-b.json, supabase/migrations/0028_leccion_en_espanol.sql]
verify: node scripts/deepseek/validar-traduccion.mjs contracts/fuentes/ict-b.json supabase/migrations/0032_ict_es.sql
setup: ninguno
rounds: 5
...
Te toca **lecciones 4 a 6**: 28 bloques, 6070 caracteres.
...
`contracts/fuentes/ict-b.json`, que te doy entero mas abajo. Cada bloque
...
Escribe `supabase/migrations/0032_ict_es.sql` y haz que salga verde:

```
node scripts/deepseek/validar-traduccion.mjs contracts/fuentes/ict-b.json supabase/migrations/0032_ict_es.sql
```

Ese verificador **lo escribio el supervisor, no tu**, y comprueba por codigo de
salida: cobertura de los 28 bloques uno a uno, que el marcado HTML se
...
- Traducir a medias y dejar bloques fuera. El verificador cuenta los 28.
