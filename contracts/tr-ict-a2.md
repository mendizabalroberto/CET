...
id: tr-ict-a2
model: chat
territory: [supabase/migrations/0034_*]
forbidden: [packages/ui/src/index.ts, supabase/migrations/0028_leccion_en_espanol.sql]
context: [contracts/fuentes/ict-a2.json, supabase/migrations/0028_leccion_en_espanol.sql]
verify: node scripts/deepseek/validar-traduccion.mjs contracts/fuentes/ict-a2.json supabase/migrations/0034_ict_es.sql
setup: ninguno
rounds: 5
...
Te toca **la leccion 2**: 33 bloques, 2463 caracteres.
...
`contracts/fuentes/ict-a2.json`, que te doy entero mas abajo. Cada bloque
...
Escribe `supabase/migrations/0034_ict_es.sql` y haz que salga verde:

```
node scripts/deepseek/validar-traduccion.mjs contracts/fuentes/ict-a2.json supabase/migrations/0034_ict_es.sql
```
