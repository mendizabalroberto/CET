...
id: tr-socials-b
model: chat
territory: [supabase/migrations/0030_*]
...
verify: node scripts/deepseek/validar-traduccion.mjs contracts/fuentes/socials-b.json supabase/migrations/0030_socials_es.sql
setup: ninguno
rounds: 5
...
Escribe `supabase/migrations/0030_socials_es.sql` y haz que salga verde:

```
node scripts/deepseek/validar-traduccion.mjs contracts/fuentes/socials-b.json supabase/migrations/0030_socials_es.sql
```
