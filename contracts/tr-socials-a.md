...
id: tr-socials-a
model: chat
territory: [supabase/migrations/0029_*]
forbidden: [packages/ui/src/index.ts, supabase/migrations/0028_leccion_en_espanol.sql]
context: [contracts/fuentes/socials-a.json, supabase/migrations/0028_leccion_en_espanol.sql]
verify: node scripts/deepseek/validar-traduccion.mjs contracts/fuentes/socials-a.json supabase/migrations/0029_socials_es.sql
setup: ninguno
rounds: 5
...
Te toca **lecciones 1 a 3**: 31 bloques, 8798 caracteres.
...
`contracts/fuentes/socials-a.json`, que te doy entero mas abajo. Cada bloque
...
Escribe `supabase/migrations/0029_socials_es.sql` y haz que salga verde:

```
node scripts/deepseek/validar-traduccion.mjs contracts/fuentes/socials-a.json supabase/migrations/0029_socials_es.sql
```

Ese verificador **lo escribio el supervisor, no tu**, y comprueba por codigo de
salida: cobertura de los 31 bloques uno a uno, que el marcado HTML se
...
- Traducir a medias y dejar bloques fuera. El verificador cuenta los 31.
