...
id: tr-socials-b6
model: chat
territory: [supabase/migrations/0049_*]
forbidden: [packages/ui/src/index.ts, supabase/migrations/0028_leccion_en_espanol.sql]
context: [contracts/fuentes/socials-b6.json, supabase/migrations/0028_leccion_en_espanol.sql]
verify: node scripts/deepseek/validar-traduccion.mjs contracts/fuentes/socials-b6.json supabase/migrations/0049_socials_es.sql
setup: ninguno
rounds: 5
...
La materia **socials** (Sociales) esta sembrada en produccion
...
Te toca **la leccion 6**: 12 bloques, 2760 caracteres.
...
`contracts/fuentes/socials-b6.json`, que te doy entero mas abajo. Cada bloque
...
Escribe `supabase/migrations/0049_socials_es.sql` y haz que salga verde:

```
node scripts/deepseek/validar-traduccion.mjs contracts/fuentes/socials-b6.json supabase/migrations/0049_socials_es.sql
```
