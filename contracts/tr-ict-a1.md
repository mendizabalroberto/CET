...
context: [contracts/fuentes/ict-a1.json, supabase/migrations/0028_leccion_en_espanol.sql]
verify: node scripts/deepseek/validar-traduccion.mjs contracts/fuentes/ict-a1.json supabase/migrations/0031_ict_es.sql
setup: ninguno
rounds: 5
...
Te toca **la leccion 1**: 12 bloques, 1631 caracteres.
...
`contracts/fuentes/ict-a1.json`, que te doy entero mas abajo. Cada bloque
...
```
node scripts/deepseek/validar-traduccion.mjs contracts/fuentes/ict-a1.json supabase/migrations/0031_ict_es.sql
```

Ese verificador **lo escribio el supervisor, no tu**, y comprueba por codigo de
salida: cobertura de los 12 bloques uno a uno, que el marcado HTML se
...
- Traducir a medias y dejar bloques fuera. El verificador cuenta los 12.
